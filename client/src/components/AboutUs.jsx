  ...
  return (
    <div>
      ...
      <div className="container my-5 ">
        {/* Banner Section */}
        <div className="banner-container text-center animate__animated animate__fadeInDown">
          <img
            src="/Stall Facia.jpg"
        ...
        <div className="text-center intro-text animate__animated animate__fadeIn">
        ...
        <div className="row mt-5 align-items-center">
          <div className="col-md-6">
            <div className="content-box animate__animated animate__slideInLeft">
          ...
          <div className="col-md-6">
            <div className="content-box animate__animated animate__slideInRight">
        ...
        <div className="services mt-5">
          <h2 className="text-center fw-bold animate__animated animate__fadeInUp">What We Offer</h2>
          <div className="row service-container">
            <div className="col-md-4">
              <div className="card service-card animate__animated animate__fadeInLeft">
            ...
            <div className="col-md-4">
              <div className="card service-card animate__animated animate__fadeInUp">
                <div className="card-body text-center">
            ...
            <div className="col-md-4">
              <div className="card service-card animate__animated animate__fadeInRight">
                <div className="card-body text-center">
        ...
        <div className="text-center mt-5">
          <a href="/ContactUs" className="get-in-touch animate__animated animate__pulse animate__infinite">
            Get in Touch
          </a>
        </div>
      </div>
